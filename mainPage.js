...
function append_cards(object) {
  object.forEach((ele) => {
    ...
    img_brand_logo.src =
      "https://static.tacdn.com/img2/branding/hotels/Agoda.png";
    ...
    cont2_1_vw.append(cont1_1_vw,cont1_3_vw, cont1_2_vw );
...
let span_city = document.getElementById("Title_city_vw");
span_city.innerText = city + " ";
...
document.querySelector(".plus_btn_vw2").addEventListener("click", function () {
  adultCount();
});

document.querySelector(".minus_btn_vw2").addEventListener("click", function () {
  Decrease_adultCount();
});
...
function adultCount() {
  ...
  let display = document.getElementById("num2");
  display.innerText = adult_count;
}

function Decrease_adultCount() {
  adult_count--;
  let display = document.getElementById("num2");
  display.innerText = adult_count;
}
...
document.querySelector(".plus_btn_vw3").addEventListener("click", function () {
  childCount();
});

document.querySelector(".minus_btn_vw3").addEventListener("click", function () {
  Decrease_childCount();
});
...
function childCount() {
  ...
  let display = document.getElementById("num3");
  display.innerText = children_count;
}

function Decrease_childCount() {
  children_count--;
  let display = document.getElementById("num3");
  display.innerText = children_count;
}
...
let cityNameBanner = document.getElementById("Title_city_vw");
cityNameBanner.innerText = city +" ";
...
function append_cards(object) {
  ...
  object.forEach((ele) => {
    ...
    cont2_1_vw.append(cont1_1_vw,cont1_2_vw ,cont1_3_vw);

    cont2_vw.append(hotelName_vw, sponsor, cont2_1_vw);
